...
Our work will apply a Twitter hate speech dataset from Manoel Horta Ribeiro, et al., \cite{HatefulUsersTwitter}\cite{ribeiro2017like}. They used this dataset to characterize Twitter users as either hateful or not, in order to analyze patterns and trends among the users labeled as hateful. Instead we will use this dataset to train a neural network to detect hate speech, and we will use this neural network to create a Discord realtime hate speech detection bot.
