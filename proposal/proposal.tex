...
Our work will apply Twitter hate speech data from Manoel Horta Ribeiro, et al., \cite{HatefulUsersTwitter}\cite{ribeiro2017like}. They used this data to characterize Twitter users as either hateful or not, in order to analyze patterns and trends among the users labeled as hateful. We will be applying this dataset to a Discord context by creating a realtime hate speech detection bot. 
...
Miles will integrate the neural network into an online hate speech detection service that can be used by the Discord bot. 
